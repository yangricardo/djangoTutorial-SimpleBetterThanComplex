...
class BoardTopicTests(TestCase):
	...
	def test_board_topics_view_success_status_code(self):
		...
		is testing if Django is returning a status code 200 
		(success) for an existing Board.
		"""
	...
	def test_board_topics_view_not_found_status_code(self):
	    ...
	    ethod: is testing if Django is returning a status code 404 
	    (page not found) for a Board that doesn’t exist in the database.
		"""
	...
	def test_board_topics_url_resolves_board_topics_view(self):	
		...
		is testing if Django is using the correct view function to 
		render the topics.
		"""
...
class NewTopicTests(TestCase):
	def setUp(self):
		"""
		setUp: creates a Board instance to be 
	...
	def test_new_topic_view_not_found_status_code(self):
		...
		check if the view is raising a 404 error when 
